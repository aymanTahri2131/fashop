...
const translations = {
  fr: {
    ...
    info: {
      ...
      address: "Adresse",
      addressValue: "123 Rue des Artisans, Marrakech, Maroc",
      email: "Email",
      phone: "Téléphone",
  ...
  en: {
    ...
    info: {
      ...
      address: "Address",
      addressValue: "123 Artisan Street, Marrakech, Morocco",
      email: "Email",
      phone: "Phone",
      hours: "Opening Hours",
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#F0E4CF]/30 rounded-lg shadow-sm p-8">
          ...
          {/* Contact Info */}
          <div>
            <div className="bg-[#F0E4CF]/30 rounded-lg shadow-sm p-10">
              <h2 className="text-xl font-semibold mb-6 text-[#bc6c39]">{t.info.title}</h2>

              <div className="space-y-6">
                <div>
                  <h3 className="text-md font-medium mb-2">{t.info.address}</h3>
                  <p className="text-gray-500">{t.info.addressValue}</p>
                </div>

                <div>
                  <h3 className="text-md font-medium  mb-2">{t.info.email}</h3>
                  <p>
                    <a href="mailto:contact@florart.ma" className="text-gray-500 hover:underline">
                      contact@florart.ma
                    </a>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    <a href="tel:+212600000000" className="hover:underline text-gray-500">
                      +212 6 00 00 00 00
                    </a>
                  </p>
                </div>
                ...
                <div>
                  <h3 className="text-md font-medium  mb-2 ">{t.info.hours}</h3>
                  <p className="text-gray-500">{t.info.hoursValue}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4 mt-4">
                    <a
                      ...
                      className="text-gray-500 hover:text-[#8A9A5B] transition-colors duration-200"
                    >
                      <svg
